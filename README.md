...
solbridge is a Solidity project for blockchain tooling. It focuses on this technical goal: Model bridge accounting, mint-burn limits, and replay protection.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 180, risk penalty 7, latency penalty 4, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.

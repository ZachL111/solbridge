"""Regression checks for the solbridge casebook."""
...
from casebook.harness import assert_expected, solbridge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(solbridge_summary(), assert_expected())

...
`solbridge` is centered on blockchain tooling work in Solidity. The technical target is: Model bridge accounting, mint-burn limits, and replay protection.
...
The score is deterministic. The current threshold is 180. Risk has a penalty of 7, latency has a penalty of 4, and weight contributes a bonus of 4.
